...
sed -i '58  a\<user username="tomcat" password="raham123" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.118/conf/tomcat-users.xml
...
sudo sh apache-tomcat-9.0.118/bin/startup.sh
